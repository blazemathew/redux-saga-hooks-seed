...
import { useResourceImage } from 'src/peregrine/talons/Image/useResourceImage';

import ResourceImage from '../resourceImage';

jest.mock('src/peregrine/talons/Image/useResourceImage', () => {
    const useResourceImageTalon = jest.requireActual(
        'src/peregrine/talons/Image/useResourceImage'
    );
